...
const accentMap = {
  bronze: {
    ...
    initials: "bg-bronze-400/10 text-bronze-400 border-bronze-400/30",
    tag: "bg-bronze-400/10 text-bronze-400/80 border-bronze-400/20",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-black text-white leading-tight mb-4">
            The Command
            <span className="text-bronze-400"> Architecture</span>
          </h2>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-start justify-between mb-5">
                    ...
                    <a
                      ...
                      className="text-gray-700 hover:text-bronze-400 transition-colors"
                    >
                      <Linkedin size={16} />
                    </a>
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="text-bronze-400 text-xs font-bold">
                      {leader.role}
                    </div>
        ...
        >
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 py-3 border border-bronze-400/20 hover:border-bronze-400/50 text-gray-400 hover:text-bronze-400 text-sm font-medium transition-all duration-200 rounded-sm"
          >
            <Linkedin size={15} />
