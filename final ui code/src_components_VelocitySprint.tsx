      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-black text-white leading-tight mb-4">
            The 60-Day
            <span className="text-bronze-400"> Velocity Sprint</span>
          </h2>
          <p className="text-gray-400 text-lg max-w-2xl">
            Five precision phases. Sixty days. Enterprise-grade digital
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-[52px] left-[10%] right-[10%] h-px bg-gradient-to-r from-transparent via-bronze-400/30 to-transparent z-0" />
                ...
                <div className="p-4 border-b border-bronze-400/10 flex items-center gap-3">
                  <div className="relative">
                    <div className="w-10 h-10 rounded-full border-2 border-bronze-400/30 group-hover:border-bronze-400/60 flex items-center justify-center bg-obsidian-900 transition-all duration-300">
                      <phase.icon size={16} className="text-bronze-400" />
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="text-[10px] font-mono text-bronze-400/70">
                      {phase.days}
                    </div>
                  </div>
                </div>
