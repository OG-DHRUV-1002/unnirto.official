...
const categories = [
  ...
  },
  {
    ...
    description:
      "We extract legacy systems and re-architect them as cloud-native platforms. Our migration methodology ensures zero data loss, minimal business disruption, and a complete handover within the 60-Day Velocity Sprint framework.",
    points: [
  ...
  },
  {
    ...
    headline: "The Antigravity Framework — Frictionless Deployments",
    description:
      "We run the Antigravity Framework: automated CI/CD, containerized deployments, and zero-maintenance-window releases. Blameless post-mortems treat every incident as a data point, not a blame game.",
    points: [
...
const accentConfig = {
  bronze: {
    ...
    tag: "bg-bronze-400/10 text-bronze-400 border-bronze-400/20",
    bullet: "bg-bronze-400",
    icon: "text-bronze-400 bg-bronze-400/10",
    bar: "bg-bronze-400",
  },
  olive: {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-bronze-400 text-xs font-mono tracking-widest uppercase">Core Capabilities</span>
          </div>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <h2 className="text-4xl md:text-5xl font-black text-white leading-tight">
              The Engineering <span className="text-bronze-400">Matrix</span>
            </h2>
            ...
            {categories.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-4 p-4 rounded-sm border text-left transition-all duration-200 group ${
                    isActive ? c.active : c.inactive
                  }`}
                >
                  <div className={`w-9 h-9 rounded-sm flex items-center justify-center shrink-0 transition-all ${
                    isActive ? c.icon : "text-gray-600 bg-gray-800/50"
                  }`}>
                    <cat.icon size={17} />
                  </div>
