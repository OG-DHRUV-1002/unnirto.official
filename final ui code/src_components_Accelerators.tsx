    ...
    <section id="accelerators" className="relative py-28 px-6">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    <span
                      className={`text-[10px] font-mono px-2 py-0.5 rounded-full border ${
                        acc.status === "Production Proven"
                          ...
                          : "text-bronze-400 bg-bronze-400/10 border-bronze-400/20"
                      }`}
                    >
                      {acc.status}
                    </span>
        ...
        >
          ...
          <a
            href="#trust"
            className="flex items-center gap-2 px-6 py-3 bg-bronze-400/10 border border-bronze-400/30 text-bronze-400 text-sm font-bold hover:bg-bronze-400/20 transition-all duration-200 rounded-sm whitespace-nowrap"
          >
