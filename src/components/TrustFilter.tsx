...
const trustBadges = [
  {
    ...
    desc: "Every deployment uses the Advance Framework. No maintenance windows.",
  },
  {
    icon: Lock,
...
const faqs = [
  {
    ...
    a: "We operate on project-based and retainer engagements. Most enterprise builds follow our 30-Day Velocity Sprint. Retainers are available for ongoing product scaling, DevOps management, and AI workflow iteration.",
  },
  {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-black text-white leading-tight mb-4">
            Ready to
            <span className="text-[#9E8A26]"> Engage?</span>
          </h2>
          ...
          {trustBadges.map((badge, i) => (
            ...
            >
              <div className="w-10 h-10 rounded-sm bg-bronze-400/10 border border-bronze-400/20 flex items-center justify-center shrink-0">
                <badge.icon size={18} className="text-[#9E8A26]" />
              </div>
              <div>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={sending}
                  className="w-full flex items-center justify-center gap-2 py-3.5 bg-bronze-400 hover:bg-bronze-300 text-obsidian-900 font-black text-sm tracking-wide transition-all duration-200 hover:shadow-lg hover:shadow-bronze-400/20 rounded-sm disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {sending ? (
                    <>
              ...
              {faqs.map((faq, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <ChevronDown
                      size={16}
                      className={`text-[#9E8A26] shrink-0 transition-transform duration-300 ${
